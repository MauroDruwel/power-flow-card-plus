  ...
  if (battery2) {
    if (battery2.color.fromBattery !== undefined) {
      ...
      main.style.setProperty(
        ...
        battery2.color.fromBattery || "#4db6ac"
      );
    }
    if (battery2.color.toBattery !== undefined) {
      ...
      main.style.setProperty("--energy-battery-in-color", battery2.color.toBattery || "#a280db");
    }
    const battery2StateOfChargeColorType = entities.battery_2?.color_state_of_charge_value;
    if (battery2StateOfChargeColorType) {
      main.style.setProperty(
        "--text-battery-state-of-charge-color",
    ...
    if (entities.battery_2?.color_circle) {
      main.style.setProperty(
        "--circle-battery-color",
        entities.battery_2.color_circle === "consumption"
          ? "var(--energy-battery-in-color)"
          : entities.battery_2.color_circle === "production"
            ? "var(--energy-battery-out-color)"
            : battery2.state.fromBattery >= battery2.state.toBattery
              ? "var(--energy-battery-out-color)"
              : "var(--energy-battery-in-color)"
    ...
    if (entities.battery_2?.color_icon) {
      main.style.setProperty(
        "--icon-battery-color",
        entities.battery_2.color_icon === "consumption"
          ? "var(--energy-battery-in-color)"
          : entities.battery_2.color_icon === "production"
            ? "var(--energy-battery-out-color)"
            : entities.battery_2.color_icon === "color_dynamically"
              ? battery2.state.fromBattery >= battery2.state.toBattery
                ? "var(--energy-battery-out-color)"
                : "var(--energy-battery-in-color)"
              : "var(--primary-text-color)"
    ...
    if (entities.battery_2?.color_value === false) {
      main.style.setProperty("--text-battery-in-color", "var(--primary-text-color)");
      main.style.setProperty("--text-battery-out-color", "var(--primary-text-color)");
    }
  }
